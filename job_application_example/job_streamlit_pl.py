...
st.title("Major US Airline Job Application with Polars")
st.write("by Tomás Lucas based on the work of Tyler Richards")
...
selected_airport = st.selectbox("Airport Code", airport_distance_df.select("Airport Code").to_series())
